...
describe Code do
  it 'has a valid factory' do
    ...
    expect(FactoryGirl.build(:code, qr: nil)).to be_valid
  end
  it 'requires used' do
    expect(FactoryGirl.build(:code, used: nil)).not_to be_valid
  end
  it 'requires active to be true or false' do
    expect(FactoryGirl.build(:code, active: 5).active).to be_falsey
    expect(FactoryGirl.build(:code, active: 'a').active).to be_falsey
