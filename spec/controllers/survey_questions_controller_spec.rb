...
describe SurveyQuestionsController do
  ...
  describe "GET new" do
    it "assigns a new survey_question as @survey_question" do
      ...
      assigns(:survey_question).should be_a_new(SurveyQuestion)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created survey_question as @survey_question" do
        post :create, {:survey_question => valid_attributes}, valid_session
        assigns(:survey_question).should be_a(SurveyQuestion)
        assigns(:survey_question).should be_persisted
      end

      it "redirects to the created survey_question" do
        post :create, {:survey_question => valid_attributes}, valid_session
        response.should redirect_to(SurveyQuestion.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved survey_question as @survey_question" do
        ...
        SurveyQuestion.any_instance.stub(:save).and_return(false)
        post :create, {:survey_question => {  }}, valid_session
        assigns(:survey_question).should be_a_new(SurveyQuestion)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested survey_question" do
        survey_question = SurveyQuestion.create! valid_attributes
        # Assuming there are no other survey_questions in the database, this
        # specifies that the SurveyQuestion created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        SurveyQuestion.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
        put :update, {:id => survey_question.to_param, :survey_question => { "these" => "params" }}, valid_session
      end

      it "assigns the requested survey_question as @survey_question" do
        survey_question = SurveyQuestion.create! valid_attributes
        put :update, {:id => survey_question.to_param, :survey_question => valid_attributes}, valid_session
        assigns(:survey_question).should eq(survey_question)
      end
      ...
      it "redirects to the survey_question" do
        survey_question = SurveyQuestion.create! valid_attributes
        put :update, {:id => survey_question.to_param, :survey_question => valid_attributes}, valid_session
        response.should redirect_to(survey_question)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the survey_question as @survey_question" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        SurveyQuestion.any_instance.stub(:save).and_return(false)
        put :update, {:id => survey_question.to_param, :survey_question => {  }}, valid_session
        assigns(:survey_question).should eq(survey_question)
      end
